...
const defaultText = `Медицинский центр "Здоровье" — современное учреждение, предоставляющее широкий спектр медицинских услуг для взрослых и детей. Наши специалисты имеют высокую квалификацию и большой опыт работы. Мы заботимся о вашем здоровье и комфорте!`;
    ...
    <div className="flex flex-col min-h-screen">
      <header className="w-full bg-blue-700 text-white py-4 shadow">
        <div className="container mx-auto flex flex-wrap items-center justify-center gap-4">
          <span className="text-2xl font-bold">Админ-панель: О клинике</span>
        </div>
      </header>
      ...
      <main className="flex flex-1 flex-col items-center p-8">
        <h2 className="text-2xl font-bold mb-6">Редактирование страницы "О клинике"</h2>
        {edit ? (
